...
class Product(TimeStampedModel):
    ...
    sale_from = models.CharField(max_length=100, null=True, blank=True)
    sale_till = models.CharField(max_length=100, null=True, blank=True)
    ...
    stock_management = models.BooleanField(verbose_name="stock_management", default=True)
    ...
    def create_product(self, store, name, category, price, discounted_price, description, s_description, stk_cnt,
                       sale_from=None, sale_till=None):
        self.name = name
        self.product_category = category
        self.price = price
        self.description = description
        self.sale_percent = discounted_price
        self.short_description = s_description
        self.stock_count = stk_cnt
        self.store = store
        self.sale_from = sale_from
        self.sale_till = sale_till
        self.save()
