...
$("#pagination-snap").append(
  "<li class='page-item'><a id='next-page' class='page-link' href='javascript:void(0)'>Next</a></li>"
);
...
$("#next-page").on("click", function () {
  ...
  if (currentPage === totalPages) {
    ...
    $(
      "#pagination-snap li.current-page:eq(" + (currentPage - 1) + ")"
    ).addClass("active"); // Make new page number the 'active' page
  }
});
